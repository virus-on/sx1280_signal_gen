...
// .btn-apply{background:var(--accent);color:#000;margin-top:14px;opacity:.35;pointer-events:none}
// .btn-apply.dirty{opacity:1;pointer-events:auto}
...
// <script>
// // ── Pending (local) state — only the user changes these ──
// var pendingFreq = 2450, pendingPwr = 10;

// // ── Committed (device) state — only server responses change these ──
...
// function markDirty() {
//   dirty = true;
//   document.getElementById('applyBtn').classList.add('dirty');
//   document.getElementById('freqVal').classList.add('dirty');
//   document.getElementById('pwrVal').classList.add('dirty');
// }

// function markClean() {
//   dirty = false;
//   document.getElementById('applyBtn').classList.remove('dirty');
//   document.getElementById('freqVal').classList.remove('dirty');
//   document.getElementById('pwrVal').classList.remove('dirty');
// }
...
// // Sends pending RF values without changing signal state
// function applyRF() {
//   markClean();
...
// // Toggle signal — always uses current pending RF values
...
// // ── ONLY updates the status section — NEVER touches sliders ──
